<template>
    <div id="resignationReason">
        ...
        <v-card class="mx-auto table-card v-card v-sheet theme--ligh">
            <template>
                <JqxGrid ref="resignationReasonGrid" :width="'100%'" :height="695" :source="dataAdapter" 
                :columns="columns" :pageable="true" :autoheight="false" :editable="false"></JqxGrid>
            </template>
        </v-card>
...
export default{
    ...
    data() {
        ...
        return {
            ...
            columns: [
                {text: this.$t('resignationReason.reasonCode'), datafield: 'ReasonCode', width: '50%', align: 'center' },
                {text: this.$t('resignationReason.description'), datafield:'Description', width: '50%', align:"center",},
            ]
        }                 
    },
    computed: {
