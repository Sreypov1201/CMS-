<template>
    <div id="staffResignation">
        ...
        <v-card class="mx-auto table-card v-card v-sheet theme--ligh">
            ...
            <template>
                <JqxGrid ref="staffResignationGrid" :width="'100%'" :source="dataAdapter" :columns="columns" :pageable="true" :autoheight="true" :editable="false"></JqxGrid>
            </template>
        </v-card>
...
export default{
    ...
    methods: {
        ...
        editStaffResignation(item) {
            ...
            this.form.ResignedDate = item.ResignedDate;
            this.openDialog = true;
        },
