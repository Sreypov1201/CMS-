<template>
                                    ...
                                    <template>
                                        <JqxTabs ref="myTabs" style="float: left;"
                                            ...
                                            <div>
                                                ...
                                                <JqxInput
                                                    ref="descKHRef" :width="400" :height="25" :source="dataAdapter" v-model="form.DescriptionKH">   
                                                </JqxInput>
                                                <br>
                                            ...
                                            <div>
                                                ...
                                                <JqxInput
                                                    ref="descENRef" :width="400" :height="25" :source="dataAdapter" v-model="form.DescriptionEN">   
                                                </JqxInput>
                                                <br>
    ...
    <template>
        <JqxGrid ref="documentGrid" :width="'100%'" :source="dataAdapter" :columns="columns" :pageable="true" :autoheight="true" :editable="false" :selectionmode="'multiplerows'" @celldoubleclick="onCelldoubleclick"></JqxGrid>
    </template>
...
data() {
    return {
        ...
        columns: [
            ...
            {text: this.$t('document.tbTitle'), datafield:'Title', width: '14%', align:"center", editable: false,},
            {text: this.$t('document.tbType'), datafield:'StrType', width: '14%', align:"center",},
            {text: this.$t('document.tbDescriptionKH'), datafield:'DescriptionKH', width: '14%', align:"center", editable: false,},
            {text: this.$t('document.tbDescriptionEN'), datafield:'DescriptionEN', width: '14%', align:"center", editable: false,},
